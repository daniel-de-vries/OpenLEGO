function [m_wing, initial_grid] = dAEDalusSteadyModelInitializer(input_cpacs, n_seg_x, n_seg_y)
    addpath('daedalus/dAEDalus_min/dAEDalus/stdlib');
    addpath('daedalus/dAEDalus_min/dAEDalus/stdlib/tixi/matlab');
    addpath('daedalus/dAEDalus_min/dAEDalus/stdlib/tigl/matlab');
    addpath('daedalus/dAEDalus_min/dAEDalus/stdlib');
    addpath('daedalus/dAEDalus_min/dAEDalus/geometry');
    addpath('daedalus/dAEDalus_min/dAEDalus/aerodynamics');
    addpath('daedalus/dAEDalus_min/dAEDalus/structures');
    addpath('daedalus/dAEDalus_min/dAEDalus/aircraft');
    addpath('daedalus/dAEDalus_min/dAEDalus/criticaldesign');
