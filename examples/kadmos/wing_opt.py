...
def kb_deploy(n_wing_segments=2, n_load_cases=3):
    ...
    """
    from examples.kadmos.kb.kb_wing_opt import deploy
...
def kb_to_cmdows(kb_path, out_path, create_pdfs=False, open_pdfs=False, create_vistoms=False):
    ...
    from examples.disciplines.xpaths import x_c, x_epsilon, x_b, x_xsi_fs, x_xsi_rs, x_t_fs, x_t_rs, x_t_ts, x_t_bs,\
        x_obj_m_wing, x_obj_m_fuel, x_con_sigmas, x_con_buffet, x_con_exposed_area
    ...
    rcg_order = ['WOM', 'dSMI', 'dSAMI', 'dSAA', 'dSSA', 'dSLD', 'dLC', 'FWE', 'ConstraintFunctions', 'ObjectiveFunctions']
...
def generate_init_xml(xml_path, n_wing_segments=2, load_cases=None):
    ...
    from examples.disciplines.xpaths import x_m_fixed, x_m_payload, x_m_mlw, \
...
class WingDesignPlotter(BaseIterationPlotter):
    ...
    from examples.disciplines.xpaths import x_c, x_epsilon, x_b, x_Lambda, x_Gamma, x_incidence, x_xsi_fs, x_xsi_rs
...
if __name__ == '__main__':
    ...
    from openlego.xmlutils import xpath_to_param
    from examples.disciplines.xpaths import x_m_fuel, x_m_wing, x_t_fs, x_t_rs, x_t_ts, x_t_bs, x_con_exposed_area
