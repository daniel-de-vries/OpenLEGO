...
def kb_deploy():
    ...
    """
    from examples.kadmos.kb.kb_sellar import deploy
    deploy()
...
def kb_to_cmdows(kb_path, out_path, create_pdfs=False, open_pdfs=False, create_vistoms=False):
    ...
    from examples.kadmos.kb.kb_sellar import x_z1, x_z2, x_x1, x_f1, x_g1, x_g2
...
def generate_init_xml(xml_path, z1, z2, x1):
    ...
    from examples.kadmos.kb.kb_sellar import root_tag, x_x1, x_z1, x_z2
